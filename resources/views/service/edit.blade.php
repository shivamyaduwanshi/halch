...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">{{__('Update Service')}} <button class="btn btn-danger btn-dlt">Delete</button></h1>
    </div>
</div>
<br/>
        <div class="row">
            <div class="col-md-6 col-offset-md-3">
                <div class="card">
                    <div class="card-body">
                        <form class="form" action="{{route('update.service',$service->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PUT') }}
 ...
 <div class="modal fade" id="deleteModal" role="dialog">
    <div class="modal-dialog modal-md">
        <form class="form" action="{{route('delete.service')}}" method="POST">

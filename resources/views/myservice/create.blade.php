                ...
                <div class="card">
                    <div class="card-body">
                        <form class="form" action="{{route('store.myservice')}}" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="service_cost" value="{{old('service_cost')}}" placeholder="{{__('Serivce Cost')}}" required/>
                                @error('service_cost')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" name="is_active" value="1"/> {{__('Active')}}
                                </label>
                            </div>

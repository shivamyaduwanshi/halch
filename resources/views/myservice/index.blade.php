...
@section('title') {{__('My Service List')}} @endsection

@section('content')
<div class="row">
    <div class="col-lg-12">
        <h3 class="page-header">{{__('My Services')}} ({{$services->total()}})</h3>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 text-right">
        <a href="{{route('create.myservice')}}" class="btn btn-primary">{{__('Add Service')}}</a>
    </div>
</div>
<br/>
<div class="row">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                    <div class="pictures-viewers">
                                         <img data-original="{{$value->service->image}}" src="{{$value->service->image}}" width="75px" height="50px" alt="{{$value->image}}">
                                    </div>
                            </td>
                            ...
                            <td>
                                <a href="{{route('show.myservice',$value->id)}}" class="btn btn-sm btn-primary"{{__('Info')}}</a>

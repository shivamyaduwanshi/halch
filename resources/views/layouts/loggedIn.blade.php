                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        ...
                        @if(auth::user()->role_id == '1')
                            <li>
                                <a href="{{route('home')}}" class="active"><i class="fa fa-dashboard fa-fw"></i> {{__('Dashboard')}}</a>
                            </li>
                            <li>
                                <a href="{{route('index.vendor')}}"><i class="fa fa-users"></i> {{__('Vendors')}}</a>
                            </li>
                            <li>
                                <a href="{{route('index.user')}}"><i class="fa fa-users"></i> {{__('Users')}}</a>
                            </li>
                            <li>
                                <a href="{{route('index.service')}}"><i class="fa fa-leaf"></i> {{__('Services')}} </a>
                            </li>
                            <li>
                                <a href="{{route('index.category')}}"><i class="fa fa-stack-overflow"></i> {{__('Categories')}} </a>
                            </li>
                            @endif
                            @if(auth::user()->role_id == '2')
                            <li>
                                <a href="{{route('index.myservice')}}"><i class="fa fa-leaf"></i> {{__('My Services')}} </a>
                            </li>
                            @endif
                            <li>
                                <a href="{{route('index.booking')}}"><i class="fa fa-book"></i> {{__('Bookings')}} </a>
                            </li>
                        </ul>
                    </div>
                </div>

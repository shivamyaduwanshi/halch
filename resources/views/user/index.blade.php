...
<div class="row">
    <div class="col-md-12">
         <form class="form-inline">
              ...
              <a href="{{route('export.user',['search'=>Request::get('search'),'status'=>Request::get('status')])}}" class="btn btn-primary">{{__('Export')}}</a>
         </form>
    </div>
</div>
<br/>
                ...
                <tbody>
                    ...
                    @foreach ($data['users'] as $key => $value)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="{{route('show.user',$value->id)}}" class="btn btn-sm btn-primary">{{__('Info')}}</a>

...
<div class="row">
    <div class="col-lg-12 text-right">
        <a href="{{route('create.banner')}}" class="btn btn-primary">{{__('Add Banner')}}</a>
    </div>
</div>
<br/>
<div class="row">
                ...
                <tbody>
                    ...
                    @foreach ($banners as $key => $value)
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a href="{{route('show.banner',$value->id)}}" class="btn btn-sm btn-primary">{{__('Info')}}</a>
 ...
 <div class="modal fade" id="deleteModal" role="dialog">
    <div class="modal-dialog modal-md">
        <form class="form" action="{{route('delete.banner')}}" method="POST">

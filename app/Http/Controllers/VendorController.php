       ...
       if ($request->hasFile('profile_image')) {
        ...
        if($fileName)
         ...
         if($insertGetId){
           ...
           return redirect()->route('index.vendor')->with('status',true)->with('message',__('Successfully added vendor'));
         }
         else{
           return redirect()->route('index.vendor')->with('status',false)->with('message',__('Failed to add vendor'));
        }
    ...
    public function destroy(Request $request)
    {
        ...
        $user->deleted_at     = date('Y-m-d H:i:s');
         if($user->update()){
            ...
            return redirect()->route('index.vendor')->with('status',true)->with('message',__('Successfully deleted account'));
         }
         return redirect()->route('index.vendor')->with('status',false)->with('message',__('Failed to delete account'));
    }
    ...
    public function activeAccount(Request $request){
        ...
        $email    = $user->email;
         if($user->update()){
            ...
            return redirect()->route('index.vendor')->with('status',true)->with('message',__('Successfully actived account'));
         }
         return redirect()->route('index.vendor')->with('status',false)->with('message',__('Failed to active account'));
    }
    ...
    public function deactiveAccount(Request $request){
      ...
      $vendor->deactive_reason  = $request->reason;
       if($vendor->update()){
          ...
          return redirect()->route('index.vendor')->with('status',true)->with('message',__('Successfully deactive account'));
       }
       return redirect()->route('index.vendor')->with('status',false)->with('message',__('Failed to deactive account'));
  }

...
class GiftProductController extends Controller
{
    ...
    */
    public function index(Request $request){
        ...
        if ($validator->fails()) {
         ...
         $products = Product::where('marchant_id',$input['marchant_id'])->where('type','1')->whereNull('deleted_at')->orderBy('id','desc')->get();
    ...
    * Method     :- Post
    * Parameters :- marchant_id, title, description ,worth,coupon_code , limitation, start_date, end_date, image1, image2, image3
    *
    */
    public function create(Request $request){
        ...
        $rules = [
          ...
          'worth'       => 'required',
       //   'limitation'  => 'required',
          'coupon_code' => 'required|unique:products,coupon_code,null,id,deleted_at,NULL',
          'start_date'  => 'required',
          'end_date'    => 'required'
        ];
        ...
        if(strtotime($input['start_date']) > strtotime($input['end_date']))
            return response(['status'=>false,'message'=>__('Start date cannot exceed end date')],200);
    ...
    * Method     :- Post
    * Parameters :- product_id, marchant_id, title, description, worth, coupon_code , limitation, start_date, end_date, image1, image2, image3
    *
    */
    public function update(Request $request){
        ...
        $rules = [
          ...
          'worth'       => 'required',
         // 'limitation'  => 'required',
          'coupon_code' => 'required|unique:products,coupon_code,'.$id.',id,deleted_at,NULL',
          'start_date'  => 'required',
          'end_date'    => 'required'
